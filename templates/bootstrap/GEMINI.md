...
MUST: Preserve protected tokens exactly: `AGENTS.md`, `FABRIC.md`, `.fabric/rules/`, `.fabric/agents.meta.json, `.fabric/events.jsonl`, `ledger_entry`, `agent_meta`, `shadow constraints`, `Shadow Mirroring`, `MUST`, `NEVER`.
