...
export const zhCNMessages: Messages = {
  ...
  "cli.preview.arg.all": "显示所有已挂载 store 的知识(越过本项目 read-set;默认只显示本项目)。",
  ...
  "cli.audit.why.maturity-draft": "'{id}' 的 maturity={maturity} —— draft 的 guideline/model 属提案而非定论,不进 SessionStart 常驻规则层。",
  "cli.audit.why.maturity-draft.hint": "它仍可经 fab_recall 与编辑时提示取到;晋升(fab_review modify maturity: verified)后才进常驻层。",
