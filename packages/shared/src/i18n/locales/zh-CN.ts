...
export const zhCNMessages: Messages = {
  ...
  "cli.uninstall.flags.purge":
    "同时删除 .fabric/knowledge/ 子目录内容及状态文件；~/.fabric/knowledge/ 个人根永不受影响。",
  ...
  "cli.uninstall.plan.actions":
    "计划：scaffold={scaffold} bootstrap={bootstrap} mcp={mcp} purge={purge} clean-empties={cleanEmpties}",
  ...
  "cli.uninstall.wizard.purge":
    "是否一并清理 .fabric/knowledge/ 子目录内容？~/.fabric/knowledge/ 不受影响。[{defaultValue}]",
