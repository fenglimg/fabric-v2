...
function chromeStrings(): Record<string, string> {
  const keys = [
    ...
    "projects.inherited",
    "projects.forget",
    "projects.forget-intro",
    "projects.forget-cost",
    "projects.forget-where-registry",
    "projects.forget-where-config",
    "projects.forget-where-bindings",
    "projects.forget-nothing",
    "projects.forget-confirm",
    "projects.forget-cancel",
    "projects.forget-current",
    "projects.forget-done",
    "projects.forget-failed",
    "stores.title",
    "stores.intro",
    "stores.empty",
    "stores.personal",
