...
export const FABRIC_SERVER_INSTRUCTIONS = [
  ...
  "- `fab_recall(paths)` — one-shot KB recall for the files you are about to touch. Returns the relevant KB DESCRIPTIONS (`candidates[]`) plus a READ-PATH index (`paths[]`: one on-disk knowledge file per surfaced candidate).",
